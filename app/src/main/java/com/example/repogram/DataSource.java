...
public class DataSource {
    ...
    private static ArrayList<Account> generateDummyAccounts() {
        ...
        accounts.add(new Account("husein_hadar", "2049", "5,3JT", "995", R.drawable.profile_jafar_pp, R.drawable.profile_jafar_post1, R.drawable.profile_jafar_post2, R.drawable.profile_jafar_post3, null, null, null, null, null, null, R.drawable.profile_jafar_story));
        return accounts;
    }
}